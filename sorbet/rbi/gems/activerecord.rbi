...
class Arel::Attributes::Attribute < Anonymous_Struct_18
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_19
end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_22
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_23
end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_24
end
...
class ActiveRecord::Normalization::NormalizedValueType < Anonymous_Delegator_25
